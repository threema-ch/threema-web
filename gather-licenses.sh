...
LICENSE_FILES=(
    ...
    'babel-runtime' 'node_modules/@babel/runtime/LICENSE'
    'croppie' 'node_modules/croppie/LICENSE'
    'emojibase-regex' 'node_modules/emojibase-regex/LICENSE'
    ...
    'ts-loader' 'node_modules/ts-loader/LICENSE'
    'ts-log' 'node_modules/ts-log/LICENSE'
