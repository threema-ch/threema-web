...
# Either use custom userconfig.overrides.js or environment variables
if [[ -f /usr/share/nginx/html/userconfig.overrides.js ]]; then
    echo "Found /usr/share/nginx/html/userconfig.overrides.js, ignoring environment variables..."
else
    # Patch userconfig file
